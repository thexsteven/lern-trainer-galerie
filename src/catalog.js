...
const catalog = [
  ...
  reactItem("datenbanken", "Datenbank-Kompetenztrainer", "Datenbanken", "Grundlagen · SQL · Praxis", "Datenbanken modellieren, SQL anwenden und Backend-Entscheidungen sicher begründen.", "45–90 Min.", "./trainers/Datenbanken/DatenbankTrainer.jsx", "cyan"),
  reactItem("netztechnik-lernreise", "Netze wirklich verstehen", "Kommunikations- und Netztechnik", "Infrastruktur · OSI · Internet", "Netzinfrastrukturen einordnen, Schichten sicher zuweisen und Übertragungszeiten berechnen.", "45–75 Min.", "./trainers/Kommunikations- und Netztechnik/Grundlagen/NetztechnikLernreise.jsx", "teal"),
  reactItem("systemnahe-programmierung-lernreise", "Hardware nah denken", "Systemnahe Programmierung 1", "Embedded · Architektur · Sprachen", "Mikrocontroller, Programmiermodell und Übersetzung bis zum Maschinencode verbinden.", "45–75 Min.", "./trainers/Systemnahe Programmierung 1/Grundlagen/SystemnaheProgrammierungLernreise.jsx", "orange"),
